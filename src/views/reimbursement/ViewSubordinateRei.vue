<template>
  <div id="view-subordinate-rei">
    <notification3>
      <div class="vacate-table" slot="notification-reimbursement">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="报销类别：">
            <el-select v-model="formInline.category" placeholder="--所有类别--">
              ...
              <el-option label="接待" value="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="报销金额：">
            <el-input v-model="formInline.cost" placeholder="不限"></el-input>
          </el-form-item>
        </el-form>
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <div class="view-subordinate-vacate-table">
          <template>
            <el-table
              ...
              <el-table-column prop="cost" label="报销金额"   align="center">
              </el-table-column>
