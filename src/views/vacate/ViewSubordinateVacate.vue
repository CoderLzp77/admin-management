<template>
  <div id="view-subordinate-vacate">
    <notification>
      <div class="vacate-table" slot="notification-vacate">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="请假天数：">
            <el-input v-model="formInline.leaveDays" placeholder="不限"></el-input>
          </el-form-item>
        </el-form>
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
